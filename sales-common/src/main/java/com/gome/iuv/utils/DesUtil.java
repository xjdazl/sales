...
public class DesUtil {
    public static void main(String[] args) throws Exception{
        ...
        System.out.println(encrypt3DES("{\"token\":\"d0ee48629eb9f2e84ac48c8476e12fff\",\"phoneNo\":\"13913812736\",\"operateType\":2 }"));
        System.out.println("-----------------------");
        System.out.println(decrypt3DES("521kpcHZ2fcy1WqfbTv1/lF/7mPmbSSIyk/2HQff6WJxoEXdeEsFUU4RAc4GMaTi4o026wBoVAL8BI+BsuGsaamvMHNW0/3iMNEH5ClmTkRCUnjnPWxIrA=="));
    ...
    /**
     * 计算24位长1的密码byte值,首先对原始密钥做MD5算hash值，再用前8位数据对应补全后8位
     * @param strKey
     * @return
     * @throws Exception
     */
